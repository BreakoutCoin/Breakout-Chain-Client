...
public:
    ...
    boost::signals2::signal<bool (int64_t nFeeRequired, int nColor, const std::string& strCaption), boost::signals2::last_value<bool> > ThreadSafeAskFee;
    ...
    boost::signals2::signal<void (const uint256 &hash, ChangeType status)> NotifyPumpInfoChanged;
};
