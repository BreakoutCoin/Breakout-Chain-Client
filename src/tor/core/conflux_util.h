...
/* Forward decls */
/* edge_connection_t, crypt_path_t, and origin_circuit_t are already
 * typedef'd in or.h, which every translation unit including this file
 * pulls in first (verified across all current includers). Redeclaring
 * them here caused -Wtypedef-redefinition warnings under newer clang. */

#ifndef EDGE_CONNECTION_T_DEFINED
#define EDGE_CONNECTION_T_DEFINED
typedef struct edge_connection_t edge_connection_t;
#endif
#ifndef CRYPT_PATH_T_DEFINED
#define CRYPT_PATH_T_DEFINED
typedef struct crypt_path_t crypt_path_t;
#endif
#ifndef ORIGIN_CIRCUIT_T_DEFINED
#define ORIGIN_CIRCUIT_T_DEFINED
typedef struct origin_circuit_t origin_circuit_t;
#endif

#ifndef CONFLUX_T_DEFINED
#define CONFLUX_T_DEFINED
