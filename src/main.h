...
bool ProcessBlock(CNode* pfrom, CBlock* pblock, bool& fOrphan, bool fIsBootstrap=false);
...
public:
    ...
    bool IsUncolored()
    {
        return (nColor == (int) BREAKOUT_COLOR_NONE);
    }
...
public:
    ...
    */
    ...
    int GetColor() const
    {
        if (vout.size() == 0)
        {
              return (int) BREAKOUT_COLOR_NONE;
        }
...
public:
    ...
    CBlockIndex()
    {
        ...
        nChainTrust = 0;
        nCoinbaseColor = (int) BREAKOUT_COLOR_NONE;
        nFlags = 0;
        bnStakeModifier = 0;
	...
	vMoneySupply.assign(N_COLORS, 0);
        ...
        else
        {
            prevoutStake.SetNull();
            nStakeTime = 0;
            nStakeColor = (int) BREAKOUT_COLOR_NONE;
        }
