# Breakout Chain Client v1.9.0.0 — Release Notes

    version:           v1.9.0.0    (previous: v1.8.0.0)
    base commit:       2fb40ab3363acdf66e83452415a9bf8a7540901c
    release date:      Sat Aug 29 16:00:00 2026 UTC   (source-only release)
...
proof-of-work path, and **schedules four consensus changes to activate on Sun Sep 6 02:00:00 2026
UTC**.
...
| you are | take | when |
|---|---|---|
| Building from source | **v1.9.0.0** (this release) or v1.9.1.0 | now |
| Running a wallet / explorer / API service | **v1.9.1.0** | ~1 day after this release |
| Relying on signed executables | **v1.9.1.0 signed builds** | ~4–5 days before activation |

**Both v1.9.0.0 and v1.9.1.0 satisfy the fork.** v1.9.1.0 follows within about a day and adds
essential Explore functionality; signed executables will be published with it, timed to leave
several days before activation. If you build from source you do not need to wait.
...
| when (UTC) | what |
|---|---|
| Sat Aug 29 16:00 | **v1.9.0.0** — this release, source only |
| ~Sun Aug 30 | **v1.9.1.0** — source; adds essential Explore functionality |
| ~Sep 1–2 | **v1.9.1.0 signed executables** published |
| **Sun Sep 6 02:00** | **FORK ACTIVATION — all nodes must already be upgraded** |

That is a 7.4-day window from this release, and roughly 4–5 days from the signed executables.
...
**Client and network protocol version.** Client version is now **1.9.0.0**; the network protocol
